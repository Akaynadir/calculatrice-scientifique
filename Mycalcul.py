...
def matrice_page():
    ...
    Instructions = tk.Label(
        Matrix1_frame, bg='#2A363B', fg='white', font=('Aial', 10), text="Entrer le nombre des lignes aprés les nombres de colonnes. Ensuite entrer les valeurs des lignes de votre matrice  : ")
